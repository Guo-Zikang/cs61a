...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        lst = self.place.bees
        for elem in lst[:]:
            Insect.reduce_armor(elem, amount)
        Ant.reduce_armor(self, amount)
        if self.armor <= 0:
            for elem in lst[:]:
                Insect.reduce_armor(elem, self.damage)
        # END Problem 5
...
# END Problem EC
    ...
    def __init__(self, armor=1):
        ...
        if QueenAnt.numTrueQueen == 0:
            QueenAnt.numTrueQueen += 1
            self.TrueQueen = True
        else:
    ...
    def action(self, gamestate):
        ...
        if self.TrueQueen:
            ...
            p = self.place.exit
            while p:
                if p.ant and (not p.ant.is_doubled):
    ...
    def reduce_armor(self, amount):
        ...
        if self.TrueQueen and self.armor <= 0: bees_win()
        # END Problem EC
