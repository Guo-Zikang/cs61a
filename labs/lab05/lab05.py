...
def closer_city(lat, lon, city_a, city_b):
    ...
    distance_a_c = distance(city_a, c)
    distance_b_c = distance(city_b, c)
    if(distance_b_c <= distance_a_c): return get_name(city_b)
...
def add_trees(t1, t2):
    ...
    res_branch = [add_trees(b1, b2) for b1, b2 in zip(branches(t1), branches(t2))]
